        ...
        <div className="card mb-3 card-cart">
            <div className="row g-0">
                <div className="col-md-4">
                    <img className="img-fluid" src={`/img/${item.img}`} alt={`imagen de producto ${item.nombre}`} />
                </div>
                <div className="col-md-8">
                    <div className="card-body">
                        ...
                        <button className="btn btn-danger" onClick={() => 'borrar carrito'}>Eliminar Carrito</button>
                    </div>
                </div>
            </div>
        </div>
